...
type RoleRepository interface {
	...
	FindPermissionsByValue(
		ctx context.Context,
		permission []entities.PermissionValue,
	) (
		[]entities.Permission,
		error,
	)
...
type StickerRepository interface {
	// CreateStickerPack creates sticker pack and stickers. It writes sticker ids, too.
	CreateStickerPack(
		ctx context.Context,
	...
	FindStickerPacksByName(
		ctx context.Context,
		stickerPackName string,
	) (
		[]entities.StickerPack,
		error,
	)
}
